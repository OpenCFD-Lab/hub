...
namespace Foam
{
    defineTypeNameAndDebug(DAUtetOverlapVolume, 0);
}


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::DAUtetOverlapVolume::DAUtetOverlapVolume()
{}


// * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * * * //

Foam::DAUtreeBoundBox Foam::DAUtetOverlapVolume::pyrBb
(
...
bool Foam::DAUtetOverlapVolume::cellCellOverlapMinDecomp
(
...
Foam::scalar Foam::DAUtetOverlapVolume::cellCellOverlapVolumeMinDecomp
(
    const primitiveMesh& meshA,
    const label cellAI,
...
Foam::DAUtetOverlapVolume::cellCellOverlapMomentMinDecomp
(
    const primitiveMesh& meshA,
    const label cellAI,
...
Foam::labelList Foam::DAUtetOverlapVolume::overlappingCells
(
