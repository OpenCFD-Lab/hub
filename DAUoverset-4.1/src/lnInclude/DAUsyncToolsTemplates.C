...
void Foam::DAUsyncTools::combine
(
    Map<T>& pointValues,
    const CombineOp& cop,
    const label index,
...
void Foam::DAUsyncTools::syncPointMap
(
    const polyMesh& mesh,
...
template<class T, class CombineOp, class TransformOp>
void Foam::DAUsyncTools::syncEdgeMap
(
    const polyMesh& mesh,
    EdgeMap<T>& edgeValues,
    const CombineOp& cop,
...
//template<class T, class CombineOp, class TransformOp>
//void Foam::DAUsyncTools::syncPointList
//(
//    const polyMesh& mesh,
//    List<T>& pointValues,
//    const CombineOp& cop,
...
//void Foam::DAUsyncTools::syncPointPositions
//(
//    const polyMesh& mesh,
...
template<class T, class CombineOp, class TransformOp>
void Foam::DAUsyncTools::syncEdgeList
(
    const polyMesh& mesh,
    List<T>& edgeValues,
    const CombineOp& cop,
...
//template<class CombineOp>
//void Foam::DAUsyncTools::syncEdgePositions
//(
//    const polyMesh& mesh,
...
template<class T, class CombineOp, class TransformOp>
void Foam::DAUsyncTools::syncBoundaryFaceList
(
    const polyMesh& mesh,
    UList<T>& faceValues,
    const CombineOp& cop,
...
void Foam::DAUsyncTools::syncFaceList
(
    const polyMesh& mesh,
    DAUPackedList<nBits>& faceValues,
    const CombineOp& cop,
    const bool parRun
)
{
...
template<class T>
void Foam::DAUsyncTools::swapBoundaryCellList
(
    const polyMesh& mesh,
...
)
{
    ...
    DAUsyncTools::swapBoundaryFaceList(mesh, neighbourCellData);
}


template<unsigned nBits>
void Foam::DAUsyncTools::swapFaceList
(
    const polyMesh& mesh,
    DAUPackedList<nBits>& faceValues
)
...
(
    const polyMesh& mesh,
    DAUPackedList<nBits>& pointValues,
    const CombineOp& cop,
...
(
    const polyMesh& mesh,
    DAUPackedList<nBits>& edgeValues,
    const CombineOp& cop,
    const unsigned int nullValue
)
{
