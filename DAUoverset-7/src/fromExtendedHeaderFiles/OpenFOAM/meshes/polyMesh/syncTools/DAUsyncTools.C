...
void Foam::DAUsyncTools::swapBoundaryCellPositions
(
    const polyMesh& mesh,
...
)
{
    ...
    DAUsyncTools::swapBoundaryFacePositions(mesh, neighbourCellData);
}


Foam::PackedBoolList Foam::DAUsyncTools::getMasterPoints(const polyMesh& mesh)
{
...
Foam::PackedBoolList Foam::DAUsyncTools::getMasterEdges(const polyMesh& mesh)
{
...
Foam::PackedBoolList Foam::DAUsyncTools::getMasterFaces(const polyMesh& mesh)
{
...
Foam::PackedBoolList Foam::DAUsyncTools::getInternalOrMasterFaces
(
    const polyMesh& mesh
)
{
...
Foam::PackedBoolList Foam::DAUsyncTools::getInternalOrCoupledFaces
(
    const polyMesh& mesh
)
{
