...
namespace Foam
{
    ...
    addToRunTimeSelectionTable(DAUmeshToMeshMethod, waveMethod, components);
}
...
)
{
    ...
    // parallel.
    const bool oldParRun = Pstream::parRun(false); // by CWKIM
    //const bool oldParRun = Pstream::parRun(); // by SBLEE

    //Info<<"parRun check Please : "<<Pstream::parRun_<<endl; 
    ...
    else
    {
     ...
     Pstream::parRun(oldParRun);  // Restore parallel state // by SBLEE  //by CWKIM
}
...
(
    ...
    List<List<point>>& srcToTgtVec, // by SBLEE
    labelListList& tgtToSrcAddr,
    scalarListList& tgtToSrcWght,
    //pointListList& tgtToSrcVec
    List<List<point>>& tgtToSrcVec // by SBLEE
)
{
    {
